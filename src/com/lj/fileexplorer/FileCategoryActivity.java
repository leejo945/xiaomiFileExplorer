...
import com.lj.fileexplorer.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import com.lj.fileexplorer.FileCategoryHelper.CategoryInfo;
import com.lj.fileexplorer.FileCategoryHelper.FileCategory;
import com.lj.fileexplorer.FileExplorerTabActivity.IBackPressedListener;
import com.lj.fileexplorer.FileViewInteractionHub.Mode;
import com.lj.fileexplorer.Util.SDCardInfo;
...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
    ...
    static {
    	//加载category中的图片和类型
        button2Category.put(R.id.category_music, FileCategory.Music);//music
        ...
        button2Category.put(R.id.category_favorite, FileCategory.Favorite);//收藏夹
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	...
    	//返回和fragment 关联的activity。。。这里和fragment关联的activity就是FileExplorerTabActivity
    ...
    private void onCategorySelected(FileCategory f) {
    	//mFileCagetoryHelper.getCurCategory() 获得是上次显示的条目；f是当前显示的内容对应的条目
 ...
 */
    ...
    public boolean onRefreshFileList(String path, FileSortHelper sort) {
        ...
        //show empty view that if the c is empty;
