...
import com.lj.fileexplorer.FileListItem.ModeCallback;
import com.lj.fileexplorer.FileOperationHelper.IOperationProgressListener;
import com.lj.fileexplorer.FileSortHelper.SortMethod;
import com.lj.fileexplorer.FileViewActivity.SelectFilesCallback;
import com.lj.fileexplorer.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    private com.lj.fileexplorer.FileViewInteractionHub.Mode mCurrentMode;
