...
import com.lj.fileexplorer.FileSortHelper.SortMethod;
import com.lj.fileexplorer.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
    ...
    private Uri getContentUriByCategory(FileCategory cat) {
        ...
        switch(cat) {
            case Theme://  content://media/external/file
            case Doc:  //  content://media/external/file
            case Zip:  //  content://media/external/file
            case Apk:  //  content://media/external/file
                uri = Files.getContentUri(volumeName);
                break;
            case Music://    content://media/external/audio/media

                uri = Audio.Media.getContentUri(volumeName);
                break;
            case Video://  content://media/external/video/media
            
                uri = Video.Media.getContentUri(volumeName);
                break;
            case Picture://  content://media/external/images/media
...
/**
 * 这里用于真正的获取到 分类浏览低部， 音乐/视频/图片/主题/等 占用容量的大小。  
 * 以及获得获得分类浏览 每个分类中 文件的总数
 * @param fc
 * @param uri
 * @return
 */
